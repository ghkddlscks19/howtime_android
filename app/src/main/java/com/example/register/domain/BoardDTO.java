...
public class BoardDTO implements Serializable {
    ...
    public BoardDTO(Integer id, String title, String content, String hashtag, int price, String createDate, String modifyDate, String requirement, String memberId) {
        this.id = id;
        this.title = title;
        this.content = content;
        this.hashtag = hashtag;
