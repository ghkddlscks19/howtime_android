...
public class ReportDTO implements Serializable {
    ...
    public ReportDTO(Integer id, String title, String attackerNickname, String createDate, String modifyDate, String content, String memberId) {
        this.id = id;
        this.title = title;
    ...
    public ReportDTO(String title, String attackerNickname, String createDate, String modifyDate, String content, String memberId) {
        this.title = title;
        this.attackerNickname = attackerNickname;
        this.createDate = createDate;
        this.modifyDate = modifyDate;
